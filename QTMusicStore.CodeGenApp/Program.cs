//@CodeCopy
//MdStart
namespace QTMusicStore.CodeGenApp
{
    using TemplateCodeGenerator.AppLogic;
    ...
    internal partial class Program
    {
        ...
        private static void RunApp()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine($"Code generation for: {nameof(QTMusicStore)}");
                Console.WriteLine("=============================================");
                Console.WriteLine();
        ...
        private static void ExecuteCommand(string command)
        {
            ...
            {
                var logicAssemblyTypes = AppLogic.Modules.CodeGenerator.AssemblyAccess.AllTypes;
        ...
        private static string GetCurrentSolutionPath()
        {
            int endPos = AppContext.BaseDirectory
                                   .IndexOf("QTMusicStore.CodeGenApp", StringComparison.CurrentCultureIgnoreCase);
