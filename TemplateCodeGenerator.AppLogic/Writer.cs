//@CodeCopy
//MdStart
namespace TemplateCodeGenerator.AppLogic
{
    using System.Text;
    using TemplateCodeGenerator.AppLogic.Common;
    using TemplateCodeGenerator.AppLogic.Contracts;
    public static partial class Writer
    {
        ...
        public static void WriteAll(string solutionPath, ISolutionProperties solutionProperties, IEnumerable<IGeneratedItem> generatedItems)
        {
            ...
            tasks.Add(Task.Factory.StartNew((Action)(() =>
            {
                ...
                {
                    var writeItems = generatedItems.Where<IGeneratedItem>((Func<IGeneratedItem, bool>)(e => e.UnitType == UnitType.AppLogic && e.ItemType == ItemType.DbContext));
            ...
            tasks.Add(Task.Factory.StartNew((Action)(() =>
            {
                ...
                if (Directory.Exists(projectPath))
                {
                    var writeItems = generatedItems.Where<IGeneratedItem>((Func<IGeneratedItem, bool>)(e => e.UnitType == UnitType.AppLogic && e.ItemType == ItemType.Model));
            ...
            tasks.Add(Task.Factory.StartNew((Action)(() =>
            {
                ...
                if (Directory.Exists(projectPath))
                {
                    var writeItems = generatedItems.Where<IGeneratedItem>((Func<IGeneratedItem, bool>)(e => e.UnitType == UnitType.AppLogic && e.ItemType == ItemType.AccessContract));
            ...
            tasks.Add(Task.Factory.StartNew((Action)(() =>
            {
                ...
                if (Directory.Exists(projectPath))
                {
                    var writeItems = generatedItems.Where<IGeneratedItem>((Func<IGeneratedItem, bool>)(e => e.UnitType == UnitType.AppLogic && e.ItemType == ItemType.Controller));
            ...
            tasks.Add(Task.Factory.StartNew((Action)(() =>
            {
                ...
                if (Directory.Exists(projectPath))
                {
                    var writeItems = generatedItems.Where<IGeneratedItem>((Func<IGeneratedItem, bool>)(e => e.UnitType == UnitType.AppLogic && e.ItemType == ItemType.ServiceContract));
            ...
            tasks.Add(Task.Factory.StartNew((Action)(() =>
            {
                ...
                if (Directory.Exists(projectPath))
                {
                    var writeItems = generatedItems.Where<IGeneratedItem>((Func<IGeneratedItem, bool>)(e => e.UnitType == UnitType.AppLogic && e.ItemType == ItemType.Service));
            ...
            tasks.Add(Task.Factory.StartNew((Action)(() =>
            {
                ...
                if (Directory.Exists(projectPath))
                {
                    var writeItems = generatedItems.Where<IGeneratedItem>((Func<IGeneratedItem, bool>)(e => e.UnitType == UnitType.AppLogic && e.ItemType == ItemType.Facade));
            ...
            tasks.Add(Task.Factory.StartNew((Action)(() =>
            {
                ...
                if (Directory.Exists(projectPath))
                {
                    var writeItems = generatedItems.Where<IGeneratedItem>((Func<IGeneratedItem, bool>)(e => e.UnitType == UnitType.AppLogic && e.ItemType == ItemType.Factory));
        ...
        internal static void WriteCodeFiles(string projectPath, IEnumerable<IGeneratedItem> generatedItems)
        {
            foreach (var item in generatedItems)
            {
                ...
                if (item.FileExtension == AppLogic.StaticLiterals.CSharpHtmlFileExtension)
                {
                    sourceLines.Insert(0, $"@*{StaticLiterals.GeneratedCodeLabel}*@");
                }
                else
        ...
        internal static void WriteCodeFile(string filePath, IEnumerable<string> source)
        {
            var canCreate = true;
            ...
            {
                File.WriteAllLines(filePath, source, System.Text.Encoding.UTF8);
            }
        }
