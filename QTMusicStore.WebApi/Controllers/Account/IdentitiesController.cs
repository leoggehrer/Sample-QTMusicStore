...
{
    using TAccessModel = AppLogic.Models.Account.Identity;
    ...
    public sealed partial class IdentitiesController : Controllers.GenericController<TAccessModel, TEditModel, TOutModel>
    {
        ...
        /// Implemented from template developer
        ///
        public IdentitiesController(QTMusicStore.AppLogic.Contracts.Account.IIdentitiesAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
            Constructed();
