...
//MdStart
#if ACCOUNT_ON
namespace QTMusicStore.WebApi.Controllers
{
    ...
    public partial class AccountsController : ApiControllerBase
    {
        ...
        {
            var result = await AppLogic.AccountAccess.LogonAsync(logonModel.Email, logonModel.Password, logonModel.Info ?? string.Empty);
        ...
        {
            return AppLogic.AccountAccess.LogoutAsync(sessionToken);
        }
    }
}
#endif
