...
using QTMusicStore.AppLogic.Modules.Exceptions;
using QTMusicStore.AppLogic.Modules.Security;
using System.IdentityModel.Tokens.Jwt;
using System.Security.Claims;
using System.Text;
using System.Text.RegularExpressions;

namespace QTMusicStore.AppLogic.Modules.Account
{
                ...
                if (session != null && session.IsActive)
                {
                    ...
                    if (identity != null)
                    {
                        ...
                        session.JsonWebToken = JsonWebToken.GenerateToken(new Claim[]
                        {
                            ...
                            new Claim(ClaimTypes.System, nameof(QTMusicStore)),
