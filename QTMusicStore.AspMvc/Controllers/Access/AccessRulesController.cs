...
namespace QTMusicStore.AspMvc.Controllers.Access
{
    using Microsoft.AspNetCore.Mvc;
    using TAccessModel = AppLogic.Models.Access.AccessRule;
    using TViewModel = AspMvc.Models.Access.AccessRule;
    using TFilterModel = AspMvc.Models.Access.AccessRuleFilter;
    using TAccessContract = AppLogic.Contracts.Access.IAccessRulesAccess<AppLogic.Models.Access.AccessRule>;
    ///
    ...
    public sealed partial class AccessRulesController : Controllers.FilterGenericController<TAccessModel, TViewModel, TFilterModel, TAccessContract>
    {
        ...
        /// Generated by the generator
        ///
        public AccessRulesController(AppLogic.Contracts.Access.IAccessRulesAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
            Constructed();
