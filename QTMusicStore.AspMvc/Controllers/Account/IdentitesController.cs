...
namespace QTMusicStore.AspMvc.Controllers.Account
{
    ...
    using TAccessContract = AppLogic.Contracts.Account.IIdentitiesAccess<AppLogic.Models.Account.Identity>;
    ...
    public partial class IdentitiesController : Controllers.FilterGenericController<TAccessModel, TViewModel, TFilterModel, TAccessContract>
    {
        ...
        public async Task<IActionResult> CreateIdentity(Models.Account.IdentityCreate model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    await AppLogic.AccountAccess.AddAppAccessAsync(SessionWrapper.SessionToken, model.Name, model.Email, model.Password, model.TimeOutInMinutes, false);
        ...
        public Models.Account.IdentityRole[] AccessRoleList
        {
            get
            {
                if (accessRoleList == null)
                {
                    ...
                    using var ctrl = (AppLogic.Contracts.Account.IRolesAccess<AppLogic.Models.Account.Role>)services.GetService(typeof(AppLogic.Contracts.Account.IRolesAccess<AppLogic.Models.Account.Role>))!;
